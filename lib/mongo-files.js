...
MongoFiles.prototype = EventEmitter.prototype;

MongoFiles.prototype.EVENT_WRITE = 'write';
 ...
 * @param options
 */
MongoFiles.prototype.writeStream = function (id, fileStream, metaData, options) {
	return this._setup()
		.then(function (setupResults) {
			return new Promise(function (resolve, reject) {
				...
				var finalStream = fileStream.pipe(outputStream);
		...
		.then(function (writtenStream) {
			...
			return new Promise(function (resolve, reject) {
				...
				this.mongoCollection.updateOne({'_id': id}, {
					_id: id,
					path: finalPath,
					meta: metaData,
